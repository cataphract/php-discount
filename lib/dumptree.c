...
/* on merge: removed flags argument and removed compilation
 * step. In the original, the flags may or may not have been used,
 * depending on whether compilation had already occurred. */
int
mkd_dump(Document *doc, FILE *out, char *title)
{
    Stack stack;

	/* on merge: line changed: */
	if ( doc && doc->compiled ) {
